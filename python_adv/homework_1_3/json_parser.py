...
afr_news_word_dict_json = json_news_parser(os.path.join(current_path, 'files', 'newsafr.json'))
afr_news_word_dict_xml = xml_news_parser(os.path.join(current_path, 'files', 'newsafr.xml'))
